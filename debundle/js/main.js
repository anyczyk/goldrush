...
const create = () => {
    ...
    toolsGame.text.show(false,game.width-235,game.height-25,.9,'semDesign Game (' + ((typeof Android === 'object')? detectionDevice() : 'Browser') + ')'+' '+webGL+(window.navigator.onLine?' online':' offline'), '400 12px Arial' ,'#000000',true,'logoText');
