    ...
    ({
      ...
      /***/
          (function(module, __webpack_exports__, __webpack_require__) {
            ...
            __webpack_require__.d(__webpack_exports__, "setCookies", function() {
              return setCookies;
            });
            /* harmony export (binding) */
            __webpack_require__.d(__webpack_exports__, "removeCookies", function() {
              return removeCookies;
            });
            /* harmony export (binding) */
            __webpack_require__.d(__webpack_exports__, "getCookies", function() {
              return getCookies;
            });
            /* harmony import */
            var _functions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__( /*! ./functions */ "./js/functions.js");
      ...
      /*!*************************!*\
          !*** ./js/functions.js ***!
          \*************************/
      /*! exports provided: detectionDevice, debounce, detectionWEBGL, isEven, inArrayObject, inArray, isExists, removeA, randomBetween, randomArray, triggerKeyboardEvent */
      /***/
          (function(module, __webpack_exports__, __webpack_require__) {
            ...
            __webpack_require__.r(__webpack_exports__);
            /* harmony export (binding) */
            __webpack_require__.d(__webpack_exports__, "detectionDevice", function() {
            ...
            /* harmony export (binding) */
            __webpack_require__.d(__webpack_exports__, "detectionWEBGL", function() {
              return detectionWEBGL;
            });
            /* harmony export (binding) */
            ...
            /* harmony export (binding) */
            __webpack_require__.d(__webpack_exports__, "inArrayObject", function() {
            ...
            /* harmony export (binding) */
            __webpack_require__.d(__webpack_exports__, "removeA", function() {
              return removeA;
            });
            /* harmony export (binding) */
            __webpack_require__.d(__webpack_exports__, "randomBetween", function() {
            ...
            /* harmony export (binding) */
            __webpack_require__.d(__webpack_exports__, "triggerKeyboardEvent", function() {
              return triggerKeyboardEvent;
            });
            var _arguments = arguments;
            var detectionDevice = function detectionDevice() {
              var userAgent = navigator.userAgent || navigator.vendor || window.opera; //alert(userAgent);
      ...
      /***/
          (function(module, __webpack_exports__, __webpack_require__) {
            ...
            __webpack_require__.r(__webpack_exports__);
            /* harmony import */
            var _scss_index_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__( /*! ../scss/index.scss */ "./scss/index.scss");
            /* harmony import */
            var _cookies__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__( /*! ./cookies */ "./js/cookies.js");
            /* harmony import */
            var _functions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__( /*! ./functions */ "./js/functions.js");
            var _this = undefined;
            ...
            if(!Object(_functions__WEBPACK_IMPORTED_MODULE_2__["detectionWEBGL"])()) {
            ...
            var preload = function preload() {
              ...
              game.load.image('inside-house-3', 'images/inside-house-3.png'); // game.load.image('sentence1', 'images/sentence1.png');
            ...
            var toolsGame = {
              ...
              windows: {
                ...
                boxMenu: {
                  ...
                  show: function show(type) {
                    ...
                    toolsGame.buttons.fullScreenBrowser.show();
                    ...
                    if(playGame.main) {
                      ...
                      toolsGame.buttons.fullScreenBrowser.hide();
              ...
              animationImage: {
                ...
                sentence1: {
                  ...
                  show: function show() {
                    ...
                    var speedShowOpacity = 300;
                    var speedShowDelay = 300;
                    this.t1 = game.time.events.add(timeShow, function() {
                      game.add.tween(this.obj4).to({
                        alpha: 1
                      }, speedShowOpacity, Phaser.Easing.Linear.None, true);
              ...
              buttons: {
                ...
                fullScreenBrowser: {
                  show: function show() {
                    if((typeof Android === "undefined" ? "undefined" : _typeof(Android)) !== "object") {
                      if(Object(_functions__WEBPACK_IMPORTED_MODULE_2__["isExists"])(this.obj)) this.obj.destroy();
                      var x = playGame.main ? 19 * tileSize : 25 * tileSize,
                ...
                levels: {
                  ...
                  text2: [],
                  show: function show() {
                    if(Object(_functions__WEBPACK_IMPORTED_MODULE_2__["isExists"])(this.cactus)) this.cactus.destroy();
                    ...
                    if(Object(_functions__WEBPACK_IMPORTED_MODULE_2__["isExists"])(this.fog)) this.fog.destroy();
                    this.fog = game.add.image(9 * tileSize, 14 * tileSize, 'fog-single');
                    this.fog.animations.add('run');
                    this.fog.animations.play('run', 9, true);
                    this.fog.alpha = .6;
                    this.fog.fixedToCamera = true; //toolsGame.buttons.levels
                  ...
                  hide: function hide() {
                    if(Object(_functions__WEBPACK_IMPORTED_MODULE_2__["isExists"])(this.cactus)) this.cactus.destroy();
                    if(Object(_functions__WEBPACK_IMPORTED_MODULE_2__["isExists"])(this.fog)) this.fog.destroy(); //alert(toolsGame.buttons.levels.obj.length);
              ...
              mainElements: {
                player: {
                  ...
                  lostLife: function lostLife(player, amount) {
                    ...
                    if(!player.holdLostLife) {
                      ...
                      if(!levelFile.blockedKeys && toolsGame.mainElements.player.numberLifes > 0) {
                        ...
                        toolsGame.audio.scream(); //if(player.scale.y > 1) {
                      ...
                      if(toolsGame.mainElements.player.numberLifes < 1) {
                        if(!levelFile.blockedKeys && !toolsGame.mainElements.player.gameOver) {
                          ...
                          toolsGame.mainElements.player.numberLifes = 0; // if(toolsGame.mainElements.player.gun.obj) {
                  ...
                  gun: {
                    ...
                    playerGun: function playerGun(player) {
                      ...
                      if(fireButton.isDown && toolsGame.mainElements.player.numberLifes && !levelFile.blockedKeys) {
                        if(player.countBullets > 0 && game.time.now > player.bulletTime) {
                          ...
                          if(player.bullet) {
                            ...
                            game.time.events.remove(player.gun.startGun); // xxxx

                            if(player.gun.obj.alpha === 0) {
                              player.gun.obj.alpha = 1; //player.gun.obj = game.add.image(player.obj.x, player.obj.y, "gun");
                            }
                            ...
                            player.gun.startGun = game.time.events.add(1000, function() {
                              if(player.gun.obj.alpha === 1) {
                                ...
                                player.gun.obj.alpha = 0; //player.gun.obj=false;
                  ...
                  scale: function scale(type) {
                    ...
                    if(type === 'increase') {
                      ...
                      playerSpeedLeftRight = 200; //this.obj.scale.setTo(1,1);
                ...
                insideHouses0: {
                  insideHouse0: [],
                  add: function add(x, y, randomString) {
                    // if(this.obj) this.obj.destroy();
                    ...
                    this.insideHouse0[randomString].randomString = randomString; // const xx = toolsGame.createCenterObject(this.obj,x,y,"building4");
                    // game.physics.enable(xx, Phaser.Physics.ARCADE);
                    // xx.body.allowGravity = false;
                  },
                  hide: function hide(randomString) {
                ...
                insideHouses1: {
                  ...
                  add: function add(x, y, randomString) {
                    ...
                    this.insideHouse1[randomString].alpha = 0; // insideHouse1.visible =  visible;
                    ...
                    this.insideHouse2[randomString].alpha = 0; // insideHouse2.visible =  visible;
                  ...
                  hide: function hide(randomString) {
                    if(Object(_functions__WEBPACK_IMPORTED_MODULE_2__["isExists"])(this.insideHouse0[randomString])) this.insideHouse0[randomString].destroy();
                    if(Object(_functions__WEBPACK_IMPORTED_MODULE_2__["isExists"])(this.insideHouse1[randomString])) this.insideHouse1[randomString].destroy();
                    if(Object(_functions__WEBPACK_IMPORTED_MODULE_2__["isExists"])(this.insideHouse2[randomString])) this.insideHouse2[randomString].destroy();
                    if(Object(_functions__WEBPACK_IMPORTED_MODULE_2__["isExists"])(this.insideHouse3[randomString])) this.insideHouse3[randomString].destroy();
                    if(Object(_functions__WEBPACK_IMPORTED_MODULE_2__["isExists"])(this.insideHouse4[randomString])) this.insideHouse4[randomString].destroy();
                  }
                },
                // insideHouses2: {
            ...
            var startGame = function startGame(type, lastMap, percentLevel) {
              ...
              game.time.events.add(loaderSpeed, function() {
                ...
                toolsGame.mainElements.insideHouses0.obj.enableBody = true; // toolsGame.mainElements.insideHouses2.obj = game.add.group();
                ...
                for(var _x = 0; _x < map.width; _x++) {
                  for(var _y = 0; _y < map.height; _y++) {
                    ...
                    if(map.getTile(_x, _y, layerObject, true).index == 14) {
                      var randomString = Math.random().toString(36).substring(7);
                      toolsGame.mainElements.insideHouses0.add(_x, _y, randomString); //alert(randomString);
                ...
                for(var _x2 = 0; _x2 < map.width; _x2++) {
                  for(var _y2 = 0; _y2 < map.height; _y2++) {
                    ...
                    if(map.getTile(_x2, _y2, layerObject, true).index == 551) {
                      toolsGame.mainElements.intruders.add(_x2, _y2, 1);
                      map.removeTile(_x2, _y2, layerObject);
                    } //generowanie intruzow typ 2


                    if(map.getTile(_x2, _y2, layerObject, true).index == 553) {
                      toolsGame.mainElements.intruders.add(_x2, _y2, 2);
                      map.removeTile(_x2, _y2, layerObject);
                    } //generowanie intruzow typ 3


                    if(map.getTile(_x2, _y2, layerObject, true).index == 554) {
                      toolsGame.mainElements.intruders.add(_x2, _y2, 3);
                      map.removeTile(_x2, _y2, layerObject);
                    } //generowanie intruzow typ 4 snake


                    if(map.getTile(_x2, _y2, layerObject, true).index == 555) {
                      toolsGame.mainElements.intruders.add(_x2, _y2, 4);
                      map.removeTile(_x2, _y2, layerObject);
                    } //generowanie intruzow typ 5 bird condor


                    if(map.getTile(_x2, _y2, layerObject, true).index == 556) {
                      toolsGame.mainElements.intruders.add(_x2, _y2, 5);
                      map.removeTile(_x2, _y2, layerObject);
                    } //generowanie intruzow typ 6 - main enemy


                    if(map.getTile(_x2, _y2, layerObject, true).index == 557) {
                      toolsGame.mainElements.intruders.add(_x2, _y2, 6);
                      map.removeTile(_x2, _y2, layerObject);
                    } //generowanie intruzow typ 7 bird owl


                    if(map.getTile(_x2, _y2, layerObject, true).index == 558) {
                      toolsGame.mainElements.intruders.add(_x2, _y2, 7);
                      map.removeTile(_x2, _y2, layerObject);
                    } // generowanie ryb
            ...
            var create = function create() {
              ...
              game.clearBeforeRender = false; //game.scale.scaleMode = Phaser.ScaleManager.SHOW_ALL;
              ...
              toolsGame.text.show(false, game.width - 235, game.height - 25, .9, 'semDesign Game (' + ((typeof Android === "undefined" ? "undefined" : _typeof(Android)) === 'object' ? Object(_functions__WEBPACK_IMPORTED_MODULE_2__["detectionDevice"])() : 'Browser') + ')' + ' ' + webGL + (window.navigator.onLine ? ' online' : ' offline'), '400 12px Arial', '#000000', true, 'logoText');
              toolsGame.buttons.openBoxMenu.show();
              toolsGame.buttons.levels.show();
              toolsGame.buttons.dude2.show(); //console.log('mute: ' + (getCookies('mute')?true:false));
            ...
            window.addEventListener('resize', function() {
              ...
              if(game.scale.isFullScreen) {
                body.classList.add('full-screen'); //toolsGame.buttons.fullScreenBrowser.show(13);
              } else {
                body.classList.remove('full-screen'); //toolsGame.buttons.fullScreenBrowser.show(12);
                // if (game.paused) {
                //     game.paused = false;
            ...
            var update = function update() {
              ...
              if(playGame.main) {
                ...
                game.physics.arcade.overlap(toolsGame.mainElements.player.gun.bullets.obj, toolsGame.mainElements.insideHouses1.obj, function(b, s) {
                  toolsGame.mainElements.explosion.add(b.body.position.x / tileSize, b.body.position.y / tileSize); //toolsGame.mainElements.stoneBigExplosion.add(s.body.position.x/tileSize, s.body.position.y/tileSize);
                  //s.kill();
                ...
                game.physics.arcade.overlap(toolsGame.mainElements.player.obj, toolsGame.mainElements.insideHouses0.obj, function(p, s) {
                  ...
                  if(p.body.position.x > s.body.position.x + 40 && p.body.position.x < s.body.position.x + 130 && p.body.position.y > s.body.position.y + 100) {
                    ...
                    if(!p.insideHouse && cursors.down.isDown) {
                      p.insideHouse = true; //alert(s.randomString);

                      p.insideHouseRandomNumber = s.randomString;
                      game.time.events.add(300, function() {
                        p.insideHouse = false;
                      }, this);
                      var x = s.body.position.x / tileSize + (s.body.width / tileSize - 1) / 2;
                      var y = s.body.position.y / tileSize + s.body.height / tileSize - 2;
                      p.body.position.y = y * tileSize - p.body.height + 20;
                      p.scale.y = .8;
                      p.scale.x = .8; // toolsGame.mainElements.insideHouses2.add(x, y);
                ...
                game.physics.arcade.overlap(toolsGame.mainElements.player.obj, toolsGame.mainElements.insideHouses1.obj, function(p, s) {
                  if(p.body.position.x > s.body.position.x + 40 && p.body.position.x < s.body.position.x + 130 && p.body.position.y > s.body.position.y + 100) {
                    ...
                    if(!p.insideHouse && cursors.down.isDown) {
                      ...
                      var x = s.body.position.x / tileSize + (s.body.width / tileSize - 1) / 2;
                      var y = s.body.position.y / tileSize + s.body.height / tileSize - 2; // if(p.tint === 16776960) {
                      //     p.scale.y = 1.08;
                      //     p.scale.x = 1;
                      // } else {
                      //     p.scale.y = 1;
                  ...
                  if(intruz.type === 6) {
                    if(intruz.randomMove === 'intrudersdleRight' || intruz.randomMove === 'intrudersdleLeft') {
                      ...
                      if(intruz.position.x > toolsGame.mainElements.player.obj.position.x - 128 && intruz.position.x < toolsGame.mainElements.player.obj.position.x + 64) {
                        ...
                        else if(intruz.randomMove === 'intrudersdleLeft') intruz.randomMove = 'intruzLeft'; // intruz.area = true;
                ...
                game.physics.arcade.overlap(toolsGame.mainElements.player.obj, toolsGame.mainElements.Lifes.obj, function(player, Life) {
                  ...
                  game.time.events.remove(toolsGame.mainElements.player.timeLife); //this.obj.tint = 16776960;
                  //if(player.scale.y === 1) {
                ...
                game.physics.arcade.overlap(toolsGame.mainElements.player.obj, toolsGame.mainElements.endLevelS.obj, function(player, end_level) {
                  if(!levelFile.readyLoad) {
                    toolsGame.mainElements.player.removeKeepStone();
                    toolsGame.audio.nextLevelNew.play(0.5); // saving to cookies
                ...
                if(!levelFile.blockedKeys) {
                  game.physics.arcade.overlap(toolsGame.mainElements.player.obj, toolsGame.mainElements.intruders.obj, function(player, intruz) {
                    if(player.scale.x !== .8) {
                      ...
                      intruz.body.checkCollision.up = false; // intruz.body.checkCollision.down = false;

                      intruz.body.checkCollision.right = false;
                      intruz.body.checkCollision.left = false;
                      game.time.events.add(300, function() {
                        intruz.body.checkCollision.up = true; // intruz.body.checkCollision.down = true;
                ...
                else timeLoop++; //console.log(timeLoop);
                      ...
                      if(intruz.type === 6) {
                        ...
                        if(intruz.body.blocked.left || intruz.body.blocked.right) {
                          ...
                          if(timeLoop === 2) {
                            ...
                            else if(intruz.body.blocked.right) intruz.randomMove = 'intrudersdleRight'; // game.time.events.add(4000,function(){
                ...
                if(_typeof(proportiesMap[levelFile.activeIdLevel]) === 'object') {
                  if(proportiesMap[levelFile.activeIdLevel].fog && proportiesMap[levelFile.activeIdLevel].fogSpeed) {
                    ...
                    else oFog.x += proportiesMap[levelFile.activeIdLevel].fogSpeed; //console.log(oFog.x);
                  }
            ...
            var game = new Phaser.Game(config); //const game = new Phaser.ScaleManager(game, 1600, 900);
            //game.scale.refresh();
            // setTimeout(function (){
            //     alert("x2");
            //     game.scale.scaleMode = Phaser.ScaleManager.RESIZE;
      ...
      /***/
          (function(module, __webpack_exports__, __webpack_require__) {
            ...
            // Module
            ___CSS_LOADER_EXPORT___.push([module.i, "/* RESET */\na, abbr, address, article, aside, audio, b, blockquote, body, button, canvas,\ncaption, cite, code, dd, del, details, dfn, div, dl, dt, em, embed, fieldset,\nfigcaption, figure, footer, form, h1, h2, h3, h4, h5, h6, hr, header, hgroup,\nhtml, i, iframe, img, input, ins, kbd, label, legend, li, mark, menu, nav,\nobject, ol, p, pre, q, samp, section, small, span, strong, sub, summary,\nsup, table, tbody, td, textarea, tfoot, th, thead, time, tr, ul, var, video, *:after, *:before {\n  margin: 0;\n  padding: 0;\n  outline: none;\n  border: none;\n  -webkit-box-sizing: border-box;\n  -moz-box-sizing: border-box;\n  box-sizing: border-box;\n}\n\nmark {\n  background-color: transparent;\n}\n\nul, ol {\n  list-style-type: none;\n}\n\ntable {\n  border-spacing: 0;\n  border-collapse: collapse;\n}\n\ncaption, th {\n  text-align: left;\n}\n\nq:after, q:before {\n  content: \"\";\n}\n\na {\n  color: inherit;\n}\n\nbody, html {\n  height: 100%;\n  width: 100%;\n}\n\n/* END RESET */\nhtml {\n  display: table;\n  table-layout: fixed;\n}\n\nbody {\n  font-family: Arial, Helvetica, sans-serif;\n  text-align: center;\n  background-color: #000;\n  color: #fff;\n  display: table-cell;\n  vertical-align: middle;\n}\nbody canvas {\n  opacity: 0;\n  pointer-events: none;\n  margin-left: auto;\n  margin-right: auto;\n}\nbody.during:after {\n  content: \"Gold Rush \\aLoading...\";\n  white-space: pre;\n  color: white;\n  font-size: 30px;\n  display: block;\n  position: absolute;\n  left: 50%;\n  top: 50%;\n  transform: translate(-50%, -50%) rotateY(0);\n  -webkit-animation: anim-logo-preloader 2.4s ease-in-out;\n  animation: anim-logo-preloader 2.4s ease-in-out;\n}\nbody.during:before {\n  content: \"semDesign\";\n  color: white;\n  margin-top: 60px;\n  font-size: 16px;\n  display: block;\n  position: absolute;\n  left: 50%;\n  top: 50%;\n  transform: translate(-50%, -50%) rotateY(0);\n  -webkit-animation: anim-logo-preloader 2.4s ease-in-out;\n  animation: anim-logo-preloader 2.4s ease-in-out;\n}\nbody.ready:after, body.ready:before {\n  display: none;\n}\nbody.ready canvas {\n  opacity: 1;\n  pointer-events: auto;\n}\n\n@keyframes anim-logo-preloader {\n  0% {\n    transform: translate(-50%, -50%) rotateY(180deg);\n    color: black;\n  }\n  30% {\n    transform: translate(-50%, -50%) rotateY(180deg);\n  }\n  60% {\n    color: black;\n  }\n  100% {\n    transform: translate(-50%, -50%) rotateY(0deg);\n    color: white;\n  }\n}\n#game-content {\n  margin: 0 auto;\n  width: 100%;\n  max-width: 1280px;\n  position: relative;\n}\nbody.full-screen #game-content {\n  max-width: none;\n}", "", {
              "version": 3,
              "sources": ["webpack://scss/index.scss"],
              "names": [],
              "mappings": "AAAA,UAAA;AAEA;;;;;;EAMI,SAAA;EACA,UAAA;EACA,aAAA;EACA,YAAA;EAEA,8BAAA;EACA,2BAAA;EACA,sBAAA;AADJ;;AAIA;EACI,6BAAA;AADJ;;AAIA;EACI,qBAAA;AADJ;;AAIA;EACI,iBAAA;EACA,yBAAA;AADJ;;AAGA;EACI,gBAAA;AAAJ;;AAGA;EACI,WAAA;AAAJ;;AAGA;EACI,cAAA;AAAJ;;AAGA;EACI,YAAA;EACA,WAAA;AAAJ;;AAGA,cAAA;AAEA;EACI,cAAA;EACA,mBAAA;AADJ;;AAGA;EACI,yCAAA;EACA,kBAAA;EACA,sBAAA;EACA,WAAA;EACA,mBAAA;EACA,sBAAA;AAAJ;AACI;EACI,UAAA;EACA,oBAAA;EACA,iBAAA;EACA,kBAAA;AACR;AAaQ;EACI,iCAAA;EACA,gBAAA;EACA,YAAA;EACA,eAAA;EACA,cAAA;EACA,kBAAA;EACA,SAAA;EACA,QAAA;EACA,2CAAA;EACA,uDAAA;EACA,+CAAA;AAXZ;AAaQ;EACI,oBAAA;EACA,YAAA;EACA,gBAAA;EACA,eAAA;EACA,cAAA;EACA,kBAAA;EACA,SAAA;EACA,QAAA;EACA,2CAAA;EACA,uDAAA;EACA,+CAAA;AAXZ;AAgBQ;EAEI,aAAA;AAfZ;AAiBQ;EACI,UAAA;EACA,oBAAA;AAfZ;;AAoBA;EACI;IAAM,gDAAA;IAAkD,YAAA;EAf1D;EAgBE;IAAO,gDAAA;EAbT;EAcE;IAAO,YAAA;EAXT;EAYE;IAAM,8CAAA;IAAgD,YAAA;EARxD;AACF;AAUA;EACI,cAAA;EACA,WAAA;EACA,iBAAA;EACA,kBAAA;AARJ;AAkBI;EACI,eAAA;AAhBR",
      ...
      /***/
          (function(module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */
            var _node_modules_css_loader_dist_cjs_js_node_modules_sass_loader_dist_cjs_js_ref_5_2_index_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__( /*! !../node_modules/css-loader/dist/cjs.js!../node_modules/sass-loader/dist/cjs.js??ref--5-2!./index.scss */ "./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js?!./scss/index.scss");
            ...
            /* harmony default export */
            __webpack_exports__["default"] = (_node_modules_css_loader_dist_cjs_js_node_modules_sass_loader_dist_cjs_js_ref_5_2_index_scss__WEBPACK_IMPORTED_MODULE_1__["default"].locals || {});
